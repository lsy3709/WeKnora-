                ...
                <div v-show="currentSection === 'basic'" class="section">
                  ...
                  <div class="settings-group">
                    ...
                    <div v-if="isBuiltinAgent" class="builtin-agent-notice">
                      ...
                      <span>{{ $t('agent.editor.noticeBuiltin') }}</span>
                    </div>
                  ...
                  <div class="settings-group">
                    ...
                    <div v-if="hasKnowledgeBase" class="setting-row">
                      ...
                      <div class="setting-control">
                        <t-select 
                          ...
                          multiple 
                          :placeholder="$t('agent.editor.allFileTypes')"
                          :min-collapsed-num="3"
                          clearable
                        >
                          <t-option 
                    ...
                    <div v-if="hasFaqKnowledgeBase" class="faq-strategy-section">
                      <div class="faq-strategy-header">
                        ...
                        <t-tooltip :content="$t('agent.editor.faqPriorityDescTooltip')">
                      ...
                      <div class="setting-row">
                        <div class="setting-info">
                          ...
                          <p class="desc">{{ $t('agent.editor.faqPriorityDesc') }}</p>
                        </div>
                        <div class="setting-control">
...
const allTools = computed(() => [
  { value: 'thinking', label: t('tools.thinking.label'), description: t('tools.thinking.description'), requiresKB: false },
  { value: 'todo_write', label: t('tools.todo_write.label'), description: t('tools.todo_write.description'), requiresKB: false },
  { value: 'grep_chunks', label: t('tools.grep_chunks.label'), description: t('tools.grep_chunks.description'), requiresKB: true },
  { value: 'knowledge_search', label: t('tools.knowledge_search.label'), description: t('tools.knowledge_search.description'), requiresKB: true },
  { value: 'list_knowledge_chunks', label: t('tools.list_knowledge_chunks.label'), description: t('tools.list_knowledge_chunks.description'), requiresKB: true },
  { value: 'query_knowledge_graph', label: t('tools.query_knowledge_graph.label'), description: t('tools.query_knowledge_graph.description'), requiresKB: true },
  { value: 'get_document_info', label: t('tools.get_document_info.label'), description: t('tools.get_document_info.description'), requiresKB: true },
  { value: 'database_query', label: t('tools.database_query.label'), description: t('tools.database_query.description'), requiresKB: true },
  { value: 'data_analysis', label: t('tools.data_analysis.label'), description: t('tools.data_analysis.description'), requiresKB: true },
  { value: 'data_schema', label: t('tools.data_schema.label'), description: t('tools.data_schema.description'), requiresKB: true },
]);
...
const availableFileTypes = computed(() => [
  { value: 'pdf', label: 'PDF', description: t('tools.fileTypes.pdf') },
  { value: 'docx', label: 'Word', description: t('tools.fileTypes.docx') },
  { value: 'txt', label: '文本', description: t('tools.fileTypes.txt') },
  { value: 'md', label: 'Markdown', description: t('tools.fileTypes.md') },
  { value: 'csv', label: 'CSV', description: t('tools.fileTypes.csv') },
  { value: 'xlsx', label: 'Excel', description: t('tools.fileTypes.xlsx') },
  { value: 'jpg', label: '图片', description: t('tools.fileTypes.jpg') },
]);
