export default {
  ...
  knowledgeBase: {
    ...
    editor: {
      createTitle: "지식베이스 생성",
      editTitle: "지식베이스 설정",
      basicInfo: "기본 정보",
      basicInfoDesc: "지식베이스의 기본 정보와 동작 방식을 설정합니다",
      mode: "실행 모드",
      agentDesc: "ReAct 추론 프레임워크를 사용하여 다단계 사고와 도구 호출이 가능합니다",
      normalDesc: "일반적인 지식베이스 기반 질의응답 모드입니다",
      name: "이름",
      namePlaceholder: "지식베이스 이름을 입력하세요",
      description: "설명",
      descriptionPlaceholder: "지식베이스에 대한 설명을 입력하세요",
      webSearchConfig: "웹 검색 설정",
      webSearchConfigDesc: "에이전트의 웹 검색 능력을 설정합니다",
      webSearch: "웹 검색 활성화",
      webSearchMaxResults: "최대 검색 결과 수",
      rerankModel: "재정렬 모델",
      rerankModelDesc: "검색 결과의 정밀도를 높이기 위해 재정렬 모델을 사용합니다",
      rerankModelPlaceholder: "재정렬 모델을 선택하세요",
      faqStrategy: "FAQ 우선 전략",
      faqStrategyDesc: "지식베이스에 FAQ가 포함된 경우 일반 문서보다 우선적으로 참조합니다",
      enableFaqPriority: "FAQ 우선 활성화",
      faqPriorityDesc: "FAQ 답변을 우선적으로 인용하여 답변 정확도를 향상시킵니다",
      directAnswerThreshold: "직접 답변 임계값",
      directAnswerThresholdDesc: "질문과 FAQ의 유사도가 이 값을 넘으면 직접 답변을 사용합니다",
      faqScoreBoost: "FAQ 점수 가중치",
      faqScoreBoostDesc: "FAQ 결과의 관련성 점수에 이 계수를 곱하여 순위를 높입니다",
      supportedFileTypes: "지원되는 파일 형식",
      supportedFileTypesDesc: "선택 가능한 파일 형식을 제한합니다 (비워두면 모든 형식 지원)",
      allFileTypes: "모든 형식",
    },
    fileName: "파일 이름",
    fileSize: "파일 크기",
  ...
  agent: {
    ...
    editor: {
      ...
      editTitle: "에이전트 설정",
      basicInfo: "기본 정보",
      basicInfoDesc: "에이전트의 기본 정보와 동작 방식을 설정합니다",
      mode: "실행 모드",
      agentDesc: "ReAct 추론 프레임워크를 사용하여 다단계 사고와 도구 호출이 가능합니다",
      normalDesc: "일반적인 지식베이스 기반 질의응답 모드입니다",
      name: "이름",
      ...
      description: "설명",
      descriptionPlaceholder: "에이전트에 대한 설명을 입력하세요",
      webSearchConfig: "웹 검색 설정",
      webSearchConfigDesc: "에이전트의 웹 검색 능력을 설정합니다",
      webSearch: "웹 검색 활성화",
      webSearchMaxResults: "최대 검색 결과 수",
      ...
      supportedFileTypesDesc: "선택 가능한 파일 형식을 제한합니다 (비워두면 모든 형식 지원)",
      allFileTypes: "모든 형식",
      noticeBuiltin: "이는 내장 에이전트입니다. 이름과 설명은 수정할 수 없지만 설정 파라미터는 조정 가능합니다",
      nameDesc: "에이전트를 쉽게 식별할 수 있는 이름을 설정하세요",
      descriptionDesc: "에이전트의 용도와 특징을 간략하게 설명하세요",
      webSearchDesc: "활성화하면 에이전트가 인터넷에서 정보를 검색할 수 있습니다",
      webSearchMaxResultsDesc: "검색당 반환되는 최대 결과 수",
      faqPriorityDescTooltip: "지식베이스에 FAQ가 포함된 경우, 일반 문서보다 FAQ 답변을 우선시하도록 합니다",
      retrievalStrategy: "검색 전략",
      retrievalStrategyDesc: "지식베이스 검색 및 정렬 파라미터를 설정합니다",
      enableQueryExpansion: "쿼리 확장 활성화",
      queryExpansionDesc: "검색 재현율을 높이기 위해 자동으로 검색어를 확장합니다",
      embeddingTopK: "벡터 검색 결과 수",
      ...
      rerankThresholdDesc: "재정렬 단계의 최소 관련성 점수",
      fallbackStrategy: "폴백 전략",
      fallbackStrategyDesc: "지식베이스에서 관련 내용을 찾지 못했을 때의 처리 방식",
      fallbackFixed: "고정 응답",
      fallbackModel: "모델 생성",
      fallbackFixedResponse: "고정 폴백 응답",
      fallbackFixedResponsePlaceholder: "관련 내용을 찾지 못했을 때 반환할 메시지를 입력하세요",
      fallbackPrompt: "폴백 프롬프트",
      fallbackPromptPlaceholder: "모델이 직접 생성할 때 사용할 프롬프트 템플릿을 입력하세요",
      knowledgeBaseScope: "지식베이스 범위",
      knowledgeBaseScopeDesc: "에이전트가 검색할 수 있는 지식베이스를 선택합니다",
      scopeAll: "전체",
      scopeSelected: "지정",
      scopeNone: "사용 안 함",
      selectKnowledgeBase: "지식베이스 선택",
      selectKnowledgeBasePlaceholder: "지식베이스를 선택해 주세요",
    },
  },
  settings: {
    title: "설정",
  ...
  tools: {
    ...
    todo_write: {
      label: "계획 수립",
      description: "구조화된 연구 계획 수립",
    },
    grep_chunks: {
      label: "키워드 검색",
      description: "특정 키워드가 포함된 문서 및 청크를 빠르게 탐색",
    },
    knowledge_search: {
      label: "시맨틱 검색",
      description: "질문을 이해하고 의미적으로 관련된 내용을 탐색",
    },
    list_knowledge_chunks: {
      label: "문서 청크 보기",
      description: "문서의 전체 청크 내용을 가져옴",
    },
    query_knowledge_graph: {
      label: "지식 그래프 조회",
      description: "지식 그래프에서 관계를 조회",
    },
    get_document_info: {
      label: "문서 정보 가져오기",
      description: "문서의 메타데이터 확인",
    },
    database_query: {
      label: "데이터베이스 조회",
      description: "데이터베이스 내 정보 조회",
    },
    data_analysis: {
      label: "데이터 분석",
      description: "데이터 파일을 이해하고 데이터 분석 수행",
    },
    data_schema: {
      label: "데이터 메타정보 확인",
      description: "표 형식 파일의 메타정보(스키마) 가져오기",
    },
    fileTypes: {
      pdf: "PDF 문서",
